...
Current check inventory: `test` from the `ci` workflow. It runs tests, retraining, and the fairness audit. It does not currently enforce lint, static types, coverage, security scanning, or wheel usability.
...
TODO: complete the scoped acceptance criteria in the [engineering follow-up](https://github.com/marinasofia/bank-churn-model/issues/6).
